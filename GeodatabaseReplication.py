...
def mainFunction(sourceGeodatabase,destinationGeodatabase,datasetsOption,updateMode,configFile,includeViews): # Get parameters from ArcGIS Desktop tool by seperating by comma e.g. (var1 is 1st parameter,var2 is 2nd parameter,var3 is 3rd parameter)  
    try:
        ...
        copyDatasets(sourceGeodatabase,destinationGeodatabase,datasetsOption,updateMode,configFile,featureDatasetList,"Feature Dataset",includeViews)
        
        # Get a list of the feature classes in the database
        featureClassList = arcpy.ListFeatureClasses()
        # FUNCTION - Copy over these feature classes
        copyDatasets(sourceGeodatabase,destinationGeodatabase,datasetsOption,updateMode,configFile,featureClassList,"Feature Class",includeViews)

         # Get a list of the tables in the database
        tableList = arcpy.ListTables()
        # FUNCTION - Copy over these tables
        copyDatasets(sourceGeodatabase,destinationGeodatabase,datasetsOption,updateMode,configFile,tableList,"Table",includeViews)            
...
def copyDatasets(sourceGeodatabase,destinationGeodatabase,datasetsOption,updateMode,configFile,datasetList,dataType,includeViews):                           
